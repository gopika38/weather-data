  ...
  return (
    <>
      ...
      <div className='body'>
        ...
        <h1 className=' my-5 text-center fw-bold fs-1 ms-4 header'><span className='head'>WEATHER APP</span ></h1>
          ...
          {error ? (
            <div className='error'>
              <div className="container">
                ...
                <img src="https://media1.giphy.com/media/Ll22OhMLAlVDb8UQWe/source.gif" alt="" className="img-fluid errimg"  style={{height:"150px"}}/>
