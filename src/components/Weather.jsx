...
function Weather() {
  ...
  const fetchData = async () => {
    try {
      const response = await Axios.get(
        `${baseURL}/data/2.5/weather?q=${search}&appid=${API_key}&units=${unit}`
      );
  ...
  const getImg = () => {
    Axios.get(
      `https://api.unsplash.com/search/photos?page=1&query=${search}&client_id=vlWvWOTSt6UkqCFZ4gX76GqacFinpC_SMqmPahXo2RI`
    )
      .then((response) => {
  ...
  useEffect(() => {
    if (search) {
      ...
      getImg();
    } // Fetch images based on the entered city
  }, [search]);

  const randomImage =
    img.length > 0
      ? img[Math.floor(Math.random() * img.length)]?.urls?.regular
      : bg;
  ...
  return (
    <>
      <div className="body">
        ...
        <h1 className=" my-5 text-center fw-bold fs-1 ms-4 header">
          ...
          {error ? (
            <div className="error">
              <div className="container">
                ...
                <img
                  src="https://media1.giphy.com/media/Ll22OhMLAlVDb8UQWe/source.gif"
                  alt=""
                  className="img-fluid errimg"
                  style={{ height: "150px" }}
                />
              </div>
            </div>
            ...
            <div className="city-info">
              ...
              >
                <div className="loc">
                  <h3>
                    <i
                      class="fa-solid fa-location-dot fa-fade"
                      style={{ color: "#fcfcfc;" }}
                    ></i>{" "}
              ...
              <div className="row ">
                <div className="col">
                  <div className="box">
                    <h5>
                      <i class="fa-solid fa-water me-2 fs-5"></i>Humidity
                    </h5>
                  ...
                  <div className="box">
                    <h5>
                      <i class="fa-solid fa-wind me-2 fs-5"></i>Wind Speed
                    </h5>
                ...
                <div className="col">
                  ...
                  <div className="box">
                    <h5>
                      <i class="fa-solid fa-wind me-2 fs-5"></i>Pressure
                    </h5>
                    <h2 className="pb-2">
                      {data?.main.pressure}
                      <span className="font2 fs-5">hPa</span>
                    </h2>
                  </div>
                </div>
              </div>
